...
namespace DeliveryApi.DAL.Migrations
{
    ...
    [Migration("20230524155310_PhotoToString")]
    partial class PhotoToString
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("delivery_backend_advanced.Models.Entities.Cook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("delivery_backend_advanced.Models.Entities.Courier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("delivery_backend_advanced.Models.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("delivery_backend_advanced.Models.Entities.Manager", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("delivery_backend_advanced.Models.Entities.DishBasketEntity", b =>
                {
                    b.HasOne("delivery_backend_advanced.Models.Entities.Customer", "Customer")
            ...
            modelBuilder.Entity("delivery_backend_advanced.Models.Entities.OrderEntity", b =>
                {
                    b.HasOne("delivery_backend_advanced.Models.Entities.Cook", "Cook")
                        .WithMany("Orders")
                        .HasForeignKey("CookId");

                    b.HasOne("delivery_backend_advanced.Models.Entities.Courier", "Courier")
                        .WithMany("Orders")
